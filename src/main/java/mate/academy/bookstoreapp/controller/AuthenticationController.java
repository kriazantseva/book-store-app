...
import mate.academy.bookstoreapp.dto.user.UserLoginResponseDto;
...
import mate.academy.bookstoreapp.security.AuthenticationService;
...
public class AuthenticationController {
    ...
    @Operation(summary = "Login the user", description = "Authenticate user")
    @ResponseStatus(HttpStatus.OK)
    @PostMapping("/login")
